...
Route::post('/switch_status_update_active/{tableName}', [AdminController::class, 'switch_status_update_active']);  // Switch Status Active
Route::post('/switch_status_update/{tableName}', [AdminController::class, 'switch_status_update']);  // Switch Status
Route::post('/switch_crm_access_update/{tableName}', [AdminController::class, 'switch_crm_access_update']);  // Switch Status
...
// DeleteWarning
Route::post('/delete_warning_id', [AdminController::class, 'Deletewarning00']);
...
### employee show Here ###
Route::get('/add-employee', [AdminController::class, 'Employee']);
// Add Employee
Route::post('/add_employee', [AdminController::class, 'addEmployee']);
Route::post('/get-managers-by-team', [AdminController::class, 'getManagersByTeam']);
Route::post('/get-team-leaders', [AdminController::class, 'getTeamLeaders']);
// Exist for empoloyee
Route::post('/check_mobile_employee_existence', [AdminController::class, 'checkMobileEmployeeExistence']);
### show_employee ###
Route::get('/show_employee', [AdminController::class, 'showEmployee']);
Route::post('/fetch_employee', [AdminController::class, 'fetchEmployee']);

// Employee Profile Fullview
Route::get('/employee-profile/{id}', [AdminController::class, 'EmployeeProfile']);
// add employee remark 
Route::post('/add_employee_remark', [AdminController::class, 'addEmployeeRemark']);
// show remark from ajax append 
Route::post('/showdata', [AdminController::class, 'showData']);
// edit Employee 
Route::get('/edit_employee', [AdminController::class, 'editEmployee']);
Route::post('/update_employee', [AdminController::class, 'updateEmployee']);
// employee Attachment
Route::post('/employee_update_attachment', [AdminController::class, 'EmployeeUpdateAttachment']);
// Attachments Show Here 
Route::get('/employee_fetch_data', [AdminController::class, 'EmployeeAttachmentShow']);
// Employee Delete Attachment Single File
Route::post('/employee_delete_attachment_single_file', [AdminController::class, 'EmployeeDeleteAttachmentSingleFile']);
// Zip Downloaded here all file 
