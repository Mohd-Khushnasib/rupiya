                            ...
                            <ul id="adminTabs" class="nav nav-tabs">
                                <li class="active">
                                    <a href="javascript:void(0);" class="admin-tab" data-status="1">
                                        <i class="fa fa-home"></i> Active <span class="notification_nav" id="active_count">0</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" class="admin-tab" data-status="0">
                                        <i class="fa fa-user"></i> Inactive <span class="notification_nav" id="inactive_count">0</span>
                                    </a>
                                </li>
                            </ul>
                            <br>
                ...
                result.forEach((item, index) => {
                    ...
                    tbody.append(`
                        <tr>
                            ...
                            <td>${item.gender}</td>
                            <td>
                                <span class="label ${item.employee_status === 'NEW EMPLOYEE' ? 'label-info' : 'label-success'}">
                        ...
                        if (willUpdate) {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    let newStatus = checkedVal; // Updated status ke according tab change
                                    // Active tab ko switch karein
                                    $('.admin-tab').parent().removeClass('active'); // Remove active class
                            ...
                            $(this).prop('checked', !isChecked); // Revert if canceled
