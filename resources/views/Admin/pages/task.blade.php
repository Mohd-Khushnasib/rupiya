                                ...
                                <form id="add_form" method="post" class="mail-compose form-horizontal" action="javascript:void(0);">
                                    ...
                                    <p>
                                        <select name="task_type[]" data-placeholder="Type Task"
                                            class="form-control AddChosen chosen" tabindex="6">
                            ...
                            <div class="row">
                                <form class="edit_task" action="javascript:void(0);" enctype="multipart/form-data" method="post">
                                    ...
                                    <input type="hidden" name="task_id" id="edit_task_id" value=""
                                        class="form-control edit_task_id">
                                    <!-- Task Id -->
                                    ...
                                    <div class="col-sm-12" style="margin-bottom: 10px">
                                        ...
                                        <input type="text" name="subject" id="edit_subject" class="form-control edit_subject"
                                            disabled>
                                    </div>
                                ...
                                <div class="col-sm-6" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-sm-6" style="margin-top: 10px;">
                                        ...
                                        <select name="assign[]" id="edit_assign" data-placeholder="Assign"
                                            class="form-control chosen EditChoosen edit_assign" multiple="multiple" tabindex="6"
                                            disabled>
                                            <optgroup label="Designation">
                                                @foreach($admins as $item)
                                                    <option value="{{ $item->id }}">{{ $item->name ?? '' }}</option>
                                    ...
                                    <div class="col-sm-12"
                                        ...
                                        <button id="task_status_button" class="btn btn-success task_status_button"
                                            style="margin: 0 auto;" type="button">Task Closed</button>
                                        <!-- Task Status Check -->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="messages-input-form">
                                                                <form class="add_comment_task" method="POST"
                                                                    action="javascript:void(0);">
                                                                    @csrf
                                                                    <div class="input">
                                                                        <input type="hidden" name="task_id" id="comment_task_id"
                                                                            class="comment_task_id" value="">
