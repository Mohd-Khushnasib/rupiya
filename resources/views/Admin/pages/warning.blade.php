                            ...
                            <div class="tabbable">
                                ...
                                <div id="myTabContent1" class="tab-content">
                                    ...
                                    <div class="tab-content">
                                        <!-- ✅ All Warnings Tab (Visible only for Admin & HR) -->
                                        @if ($admin_role === 'Admin')
                                        ...
                                        <!-- ✅ Team Warnings Tab (Visible for Managers & TLs) -->
                                        <div class="tab-pane fade in {{ $admin_role !== 'Admin' ? 'active' : '' }} all_tabs_bg" id="teamwarning">
                                            <div class="boligation_tabls">
                                                <div class="row">
                                                    <div class="col-md-12" style="margin-top: 20px;">
                                                        <div class="table-responsive" style="border:0">
